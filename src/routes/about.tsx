...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "За нас — Еколаб2018 ООД" },
      { name: "description", content: "Новооткрито дружество, посветено на прецизния химичен анализ и опазването на околната среда." },
      { property: "og:title", content: "За нас — Еколаб2018 ООД" },
      { property: "og:description", content: "Прецизен химичен анализ и опазване на околната среда." },
      { property: "og:image", content: labImg.url },
    ],
  }),
  component: About,
});
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="container-page grid gap-12 py-20 md:grid-cols-2 md:items-center">
          ...
          <div className="overflow-hidden rounded-3xl border border-border">
            <img src={labImg.url} alt="Модерна химическа лаборатория" className="h-full w-full object-cover" />
          </div>
        </div>
      </section>
