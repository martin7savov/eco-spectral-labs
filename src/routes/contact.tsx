...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Контакти — Еколаб2018" },
      { name: "description", content: "Заявете лабораторен анализ или ни изпратете запитване. Ще се свържем с вас в рамките на 24 часа." },
      { property: "og:title", content: "Контакти — Еколаб2018" },
      { property: "og:description", content: "Свържете се с нас за лабораторен анализ." },
    ],
  }),
  component: Contact,
});
