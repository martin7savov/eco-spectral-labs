...
import chemImg from "../assets/chemical.png";
...
export default function Analyses() {
  useEffect(() => {
    document.title = "Лабораторни анализи — Еколаб2018";
  }, []);
    ...
    <SiteLayout>
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="container-page grid gap-12 py-20 md:grid-cols-2 md:items-center">
          ...
          <div className="overflow-hidden rounded-3xl border border-border">
            <img src={chemImg} alt="Химичен анализ в лаборатория" className="h-full w-full object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="container-page grid gap-12 py-20 md:grid-cols-2 md:items-center">
        <div className="order-2 md:order-1 overflow-hidden rounded-3xl border border-border">
          <img src={mercuryImg} alt="Детекция на живак" className="h-full w-full object-cover" />
        </div>
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="container-page py-20">
          <div className="grid gap-12 md:grid-cols-2 md:items-start">
            ...
            <div>
              <div className="overflow-hidden rounded-3xl border border-border">
                <img src={wasteImg} alt="Лаборатория за анализ на отпадъци" className="h-full w-full object-cover" />
              </div>
